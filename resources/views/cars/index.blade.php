                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                {!! Form::open(['method' => 'GET', 'url' => '/cars', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
                            ...
                            <table class="table table-borderless">
                                ...
                                @foreach($cars as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->license }}</td>
                                        <td>
                                            <a href="{{ url('/cars/' . $item->id) }}" title="View car">
                                                <button class="btn btn-info btn-xs"><i class="fa fa-eye"
                                                                                       aria-hidden="true"></i></button>
                                            </a>
                                            <a href="{{ url('/cars/' . $item->id . '/edit') }}" title="Edit car">
